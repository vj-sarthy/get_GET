...
Beaver and colleagues’ [1] called GET as Anaerobic threshold (AT). As mentioned earlier, we will refrain from using GET and AT interchangeably. They proposed that the GET can be determined by the following method:
